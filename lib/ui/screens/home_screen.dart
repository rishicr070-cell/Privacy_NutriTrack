...
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/nutrition_ring_chart.dart';
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/meal_section.dart';
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/water_tracker.dart';
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/skeleton_loader.dart';
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/animated_progress_ring.dart';
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/animated_counter.dart';
...
import 'package:privacy_first_nutrition_tracking_app/ui/widgets/steps_widget.dart';
...
class _HomeScreenState extends State<HomeScreen>
              ...
              child: _buildQuickActionCard(
                ...
                onTap: () async {
                  ...
                  if (mealType != null && mounted) {
                    // Navigate to scanner with selected meal type
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>
                            FoodScannerScreen(mealType: mealType),
                      ),
                    );

                    // If user selected a food, navigate to add food screen
  ...
  Widget _buildMealTypeOption(
    ...
    return ListTile(
      leading: Icon(icon, color: const Color(0xFF00C9FF)),
      title: Text(mealType),
